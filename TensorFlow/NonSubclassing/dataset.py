...
class MyCustomDataset(Dataset):
    ...
    def __init__(self):
        ...
        y_bed, y_fall, y_pickup, y_run, y_sitdown, y_standup, y_walk = data_import()
...
def get_data():
    ...
    print("\nget_data time taken ", total_time.seconds, "seconds")
 
    return train_dataset, test_dataset

def save_datasets(train_dataset, test_dataset, filename="cached_datasets.pkl"):
    with open(filename, 'wb') as f:
        pickle.dump((train_dataset, test_dataset), f)

def load_datasets(filename="cached_datasets.pkl"):
...
def get_cached_data():
    ...
    if train_dataset is None or test_dataset is None:
        train_dataset, test_dataset = get_data()  # Load data from the file system
